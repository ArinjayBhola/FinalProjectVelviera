...
const Registration = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      getCurrentUser();
      navigate("/");
      showAlert("Welcome!", "Your account has been created successfully. Happy shopping!", "success");
    } catch (error) {
      showAlert("Registration Failed", "We couldn't create your account. Please check your details and try again.", "error");
    } finally {
      setLoading(false);
    }
  };
