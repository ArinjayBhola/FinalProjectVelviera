    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
      <Card className="w-full max-w-md p-8 md:p-12">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6">
          ...
          <Button type="button" variant="secondary" onClick={googleLogin} className="w-full py-3 h-12 flex items-center justify-center gap-3">
        ...
        <p className="mt-8 text-center text-sm text-[var(--text-muted)]">
          ...
          <Link to="/signup" className="font-bold text-[var(--brand-primary)] hover:underline underline-offset-4">
            Create an account
          </Link>
        </p>
      </Card>
