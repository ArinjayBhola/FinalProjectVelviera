...
import { HiOutlineCube, HiOutlineShoppingBag, HiOutlineChartPie } from "react-icons/hi2";
...
const Home = () => {
  ...
  const kpis = [
    ...
    {
      name: "Avg. Order",
      value: stats.totalOrders > 0 ? `₹${Math.round(stats.totalRevenue / stats.totalOrders)}` : "N/A",
    ...
    <div className="flex flex-col gap-8 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpis.map((kpi) => (
          <Card
            key={kpi.name}
            className="flex items-center gap-6 border-none shadow-sm hover:shadow-md transition-shadow">
